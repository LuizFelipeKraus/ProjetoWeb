...
Route::middleware('auth')->group(function(){
	...
	Route::get('/view/endereco/alterar/{id}', [EnderecoController::class, 'viewAlterarEndereco'])->name('view_alterar_endereco');				
	Route::get('/view/endereco/listar', [EnderecoController::class, 'viewListarEndereco'])->name('view_listar_endereco');

	/* Funções Endereços*/
	Route::post('/endereco/registrar',[EnderecoController::class, 'addEndereco'])->name('adicionar_endereco');		
	Route::post('/endereco/atualizar/{id}',[EnderecoController::class, 'updateEndereco'])->name('alterar_endereco');		
	Route::get('/endereco/excluir/{id}',[EnderecoController::class, 'deleteEndereco'])->name('deletar_endereco');
