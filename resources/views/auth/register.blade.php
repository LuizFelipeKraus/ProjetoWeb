                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control @error('name') is-invalid @enderror"
                                    name="name" value="{{ old('name') }}" required autocomplete="name" autofocus placeholder="Bruno">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="email" class="form-control @error('email') is-invalid @enderror"
                                    name="email" value="{{ old('email') }}" required autocomplete="email" placeholder="Exemplo@examplo">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="password" type="password"
                                    ...
                                    required autocomplete="new-password"  placeholder="Sua Senha">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="cpf" type="text" class="form-control"
                                    onkeypress="$(this).mask('000.000.000-00');" name="cpf" required autocomplete="cpf"  placeholder="123.123.123-11">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="rg" type="text" class="form-control" name="rg" required autocomplete="rg"  placeholder="1231231">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="password-confirm"
                                class="col-md-4 col-form-label  phone-ddd-mask text-md-right">Telefone</label>

                            <div class="col-md-6">
                                <input id="telefone" type="text" class="form-control" name="telefone" required
                                    autocomplete="telefone"  placeholder="(DD) 91111-1111">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="password-confirm"
